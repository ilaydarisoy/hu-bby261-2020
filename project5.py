...
class schooldb:
    def __init__(self):
        self.baglanti = sqlite3.connect("schooldb.db")
        ...
        self.tk = Tk()
        self.tk.title("schooldb")
        self.fontStilim = ("times new roman", 12)
        self.tk.geometry("700x700+600+300")
        ...
        self.etiket2 = Label(self.frame2, text="Doğum tarihi:", font=self.fontStilim)
        ...
        self.etiket5 = Label(self.frame5, text="Silinecek Satır Numarası:", font=self.fontStilim)
        ...
        self.etiket6 = Label(self.frame7, text="Güncellenecek Satır Numarası:", font=self.fontStilim)
        ...
        self.etiket8 = Label(self.frame9, text="Doğum tarihi:", font=self.fontStilim)
        ...
        self.etiket9 = Label(self.frame11, text="Aranan Satır Numarası:", font=self.fontStilim)
